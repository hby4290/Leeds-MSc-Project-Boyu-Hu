...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2fMLLABlock, C2f_DWRSeg, C2f_DLKA, C2f_DCNv3_DLKA, C2f_CGA):
                args.insert(2, n)  # number of repeats
                n = 1
        elif m in {MLLAttention, deformable_LKA_Attention, LocalWindowAttention}:
            c2 = ch[f]
            args = [c2, *args]
