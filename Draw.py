...
metrics_filename, loss_filename = plot_metrics_and_loss(
    experiment_names=['yolov8-CGARepViTBiFPNSPPELANQFLLoss', 'yolov8-CGARepViTBiFPNSPPELAN', 'yolov8-CGARepViTBiFPN', 'yolov8-RepViTBiFPN', 'yolov8-CGA', 'yolov8'], #放result.csv
