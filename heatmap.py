...
def get_params():
    params = {
        'weight': '/root/ultralytics/runs/train/yolo-CascadedGroupAttention/weights/best.pt',   # 训练出来的权重文件
        'cfg': '/root/ultralytics/ultralytics/yolov8-CGA.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/ultralytics/ultralytics/assets/01643.jpg', 'result/yolov8-CGA')  # 第一个是检测的文件, 第二个是保存的路径SS